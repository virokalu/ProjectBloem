...
const url = 'http://192.168.3.122:3000/';
const urlforsocket = 'http://192.168.3.122:3001/';
...
const getbuydata = "${url}item/allbuyitems/a";
const updQty = "${url}item/updateqty/";
...
const apiURL = "192.168.3.122:3000";
