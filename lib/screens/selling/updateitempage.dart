...
class UpdatePlaceListing extends StatefulWidget {
  const UpdatePlaceListing({Key? key}) : super(key: key);

  @override
  State<UpdatePlaceListing> createState() => _UpdatePlaceListing();
}

class _UpdatePlaceListing extends State<UpdatePlaceListing> {
...
class PreviewEdit extends StatefulWidget {
  const PreviewEdit({super.key});

  @override
  State<PreviewEdit> createState() => _PreviewEdit();
}

class _PreviewEdit extends State<PreviewEdit> {
